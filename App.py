...
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By Raghuveer Hosamani ",
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Raghuveer Hosamani*!"""})
...
if selected == "Home":
    ...
    with col2:
        st.image("icon.png", caption="Home Image", use_column_width=True)
    ...
    if uploaded_card is not None:
        ...
        def image_preview(image,res):
                for (bbox, text, prob) in res:
                    ...
                    v2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
...
#easy OCR
uploaded_card = None  # For demonstration purposes, you should assign a value to uploaded_card before using it
...
if uploaded_card is not None:
    ...
    print("Error: uploaded_card is None. Please assign a valid value to it.")
